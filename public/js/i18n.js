...
const MESSAGES = {
  en: {
    ...
    "nav.work": "work",
    "nav.blog": "blog",
    "profile.name": "Marina von Steinkirch",
    ...
    "qa.a2":
      ...
      "<br><br>" +
      'Python has since become my primary <span style="color: #b392f0;"> computer language</span> — I even <a target="_blank" href="https://github.com/cypherpunk-symposium/master-algorithms-py" rel="noopener noreferrer">published a book on it in 2014</a> (one of the first open-source Python solutions to classical computer science problems in algorithms and data structures).' +
      "<br><br>" +
      ...
      '<br><br>' +
      'Lastly, it’s important to touch on code editors. I started out as a <a href="https://github.com/cypherpunk-symposium/shell-whiz-toolkit/tree/master/vim" target="_blank">Vi(m)</a> user back in the day, then migrated to <a href="https://en.wikipedia.org/wiki/Sublime_Text" target="_blank">Sublime</a>, with a little bit of <a href="https://en.wikipedia.org/wiki/Eclipse_(software)" target="_blank">Eclipse</a>, <a href="https://en.wikipedia.org/wiki/Xcode" target="_blank">Xcode</a>, <a target="_blank" href="https://www.jetbrains.com/pycharm/">PyCharm</a>, and <a href="https://en.wikipedia.org/wiki/Atom_(text_editor)" target="_blank">Atom</a> during my PhD and early years as an engineer. Then I found <a href="https://github.com/cypherpunk-symposium/shell-whiz-toolkit/tree/master/vscode" target="_blank">VSCode</a>, and that was pretty much it for years, together with a nice <a target="_blank" href="https://singularity.nullstar.fun/tmux-shortcuts-cheatsheet.html">tmux</a> terminal setup. More recently, with AI, I experimented a little with <a href="https://en.wikipedia.org/wiki/Cursor_(editor)" target="_blank">Cursor</a> and <a href="https://herdr.dev/" target="_blank">Herdr</a>.' +
      '<br><br>' +
      'My current stack includes <a href="https://en.wikipedia.org/wiki/OpenAI_Codex" target="_blank">Codex</a>, <a href="https://en.wikipedia.org/wiki/Claude_Code" target="_blank">Claude Code</a>, <a href="https://devin.ai" target="_blank">Devin</a>, <a href="https://www.typeless.com/" target="_blank">Typeless</a> (on mobile), and my general-purpose editor <a href="https://gist.github.com/von-steinkirch/8c5fa1af95ca238665d85988782f79a5" target="_blank">Zed</a> (which is written in Rust, open-source, and multiplayer).',
  ...
  ja: {
    ...
    "nav.work": "仕事",
    "nav.blog": "ブログ",
    "profile.name": "マリーナ・フォン・シュタインキルヒ",
    ...
    "qa.a2":
      ...
      "<br><br>" +
      'それ以来Pythonが主<span style="color: #b392f0;">コンピュータ言語</span>になり、2014年には<a target="_blank" href="https://github.com/cypherpunk-symposium/master-algorithms-py" rel="noopener noreferrer">本まで出しています</a>（アルゴリズムとデータ構造における古典的な計算機科学の問題に対する、最初期のオープンソースPython解答集のひとつです）。' +
      "<br><br>" +
      ...
      "<br><br>" +
      '最後に、コードエディタについても触れておきたいと思います。私はその昔、<a href="https://github.com/cypherpunk-symposium/shell-whiz-toolkit/tree/master/vim">Vi(m)</a> ユーザーとして始め、その後 <a href="https://en.wikipedia.org/wiki/Sublime_Text">Sublime</a> に移行しました。博士課程からエンジニアとしてのキャリア初期にかけては、<a href="https://en.wikipedia.org/wiki/Eclipse_\(software\)">Eclipse</a>、<a href="https://en.wikipedia.org/wiki/Xcode">Xcode</a>、<a href="https://www.jetbrains.com/pycharm/">PyCharm</a>、<a href="https://en.wikipedia.org/wiki/Atom_\(text_editor\)">Atom</a> も少し使っていました。その後、<a href="https://github.com/cypherpunk-symposium/shell-whiz-toolkit/tree/master/vscode">VSCode</a> に出会い、それからは、快適な <a href="https://singularity.nullstar.fun/tmux-shortcuts-cheatsheet.html">tmux</a> のターミナル環境とともに、ほぼそれ一筋でした。最近では、<a href="https://en.wikipedia.org/wiki/Cursor_\(editor\)">Cursor</a> と <a href="https://herdr.dev/">Herdr</a> も少し試してみました。' +
      '<br><br>' +
      '現在のスタックには、<a href="https://en.wikipedia.org/wiki/OpenAI_Codex">Codex</a>、<a href="https://en.wikipedia.org/wiki/Claude_Code">Claude Code</a>、<a href="https://devin.ai">Devin</a>、<a href="https://www.typeless.com/">Typeless</a>（モバイル）、そして <a href="https://gist.github.com/von-steinkirch/8c5fa1af95ca238665d85988782f79a5">Zed</a>（Rust で書かれており、マルチプレイヤーでのコラボレーションにも対応しています）が含まれています。',
    ...
    "qa.a6":
      ...
      "<br><br>" +
      '<span style="color: #b392f0;">人間の言語</span>に、何十年も魅了されてきました。チョムスキーの理論から、人間がどうコミュニケーションするかの文化的・社会的な側面まで。ヨーロッパ系の家系をもつブラジルで生まれ育ち、2009年からアメリカに住んでいる私は、コミュニケーションから生じる複雑さ、そして文化が互いの理解や関わり方をいかに形づくるかを、身をもって経験してきました。' +
      "<br><br>" +
      ...
      "<br><br>" +
      '30か国以上を訪れ、何十もの都市に住み、アメリカのほぼ全州に行きました。人生の後半の目標のひとつは、家族と旅を続け、これらの経験と見てきたものについて<a href="https://matrix.nullstar.fun/" target="_blank">美しく、心を打つ物語を語ること</a>です。まだまだ何十もの国と何千もの都市が、リストに残っています。',
    "qa.q7": "宗教との関わりは？",
    "qa.a7":
