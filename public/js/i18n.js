...
const MESSAGES = {
  en: {
    ...
    "qa.a2":
      ...
      "<br><br>" +
      'These days, I\'m super fan of <a target="_blank" href="https://en.wikipedia.org/wiki/Lean_(programming_language)">Lean</a>, I build AI and backends in Python and Rust, and frontends in <a target="_blank" href="https://en.wikipedia.org/wiki/TypeScript">TypeScript</a>.',
    ...
    "qa.a6":
      "During the first part of my life, I had a big dream of exploring the world and experiencing different cultures, so I took every opportunity to travel through my research." +
      "<br><br>" +
      'Over the last decade, my work as an engineer has paid reasonably well and allowed me to work remotely, which has enabled me to pursue  <a href="https://gist.github.com/von-steinkirch/538484386a269e1ab6703ffa11480007" target="_blank">this objective</a> consistently.' +
      "<br><br>" +
  ...
  ja: {
    ...
    "qa.a2":
      ...
      "<br><br>" +
      'いまは<a target="_blank" href="https://en.wikipedia.org/wiki/Lean_(programming_language)">Lean</a>の大ファンで、AIとバックエンドはPythonとRust、フロントエンドは<a target="_blank" href="https://en.wikipedia.org/wiki/TypeScript">TypeScript</a>で書いています。',
    "qa.q3": "Linuxとの関わりは？",
    "qa.a3":
    ...
    "qa.q6": "旅との関わりは？",
    "qa.a6":
      "人生の前半、世界を探り、異なる文化を体験するという大きな夢があり、研究を通じて旅する機会はすべて取りました。" +
      "<br><br>" +
      'この十年、エンジニアとしての仕事はそこそこ報酬があり、リモートもできたので、<a href="https://gist.github.com/von-steinkirch/538484386a269e1ab6703ffa11480007" target="_blank">この目標</a>を一貫して追うことができました。' +
      "<br><br>" +
