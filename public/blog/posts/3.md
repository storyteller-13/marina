---
title: Book Review: Build a LLM from Scratch, by S. Raschka
...
> 💡 *Note that the source code for this book is [open and free](https://github.com/rasbt/LLMs-from-scratch). In addition, [own notes are also available](https://github.com/future-ai-org/random-ai-experiments-py), and as a bonus, my over-a-decade-old [implementation of some machine learning algorithms from first principle](https://github.com/future-ai-org/ml-advanced-classifiers-py).*
