---
title: 👩‍🎓 RESEARCH →  WebLLM, WebGPU, the Web Inference Stack
...
> [🎵](https://www.youtube.com/watch?v=jlIeMgsjr6c) *"The rest is silence."* — William Shakespeare, Hamlet
...
1️⃣ **[WebLLC](https://github.com/mlc-ai/web-llm)**
2️⃣ WebGPU
...
I am also working on my own ever-evolving platform to test and work through these experiments, while having some fun at the same time. I call it **My Japanese AI**. You can **[play with it](https://japanese.nullstar.fun/)** or check out its **[source code](https://github.com/storyteller-13/my_japanese_ai)**.
...
- The paper (**[arXiv:2412.15803](https://arxiv.org/html/2412.15803v2)**) splits WebLLM into three parts:

<br>

➡️ `ServiceWorkerMLCEngine`: lightweight, endpoint-like object the web developer instantiates in the page. It takes OpenAI-style JSON requests and streams back OpenAI-style JSON responses.
➡️ MLCEngine running inside a Web Worker / Service Worker: the actual computation happens off the main thread, so a long generation doesn't freeze page scrolling or input. The two halves talk via message-passing.
...
## 🏯 **[WebGPU](https://gpuweb.github.io/gpuweb/)**, *The Hardware Accelerator*
...
4️⃣ The rough mental model: WebGPU/WebNN are the standards bodies' answer to "how does a web page reach hardware acceleration," while WebLLM/Transformers.js/wllama are competing (and partly complementary) engineering answers to "how do I actually get a chat model running well on top of that."
